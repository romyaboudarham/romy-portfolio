...
const HeroSection = () => {
  return (
    <section>
      <div className="min-h-screen grid grid-cols-1 sm:grid-cols-12 relative">
        ...
        <div className="col-span-5 place-self-center mb-10 lg:mt-0">
        ...
        {/* Down Arrow Icon */}
        <div className="absolute mb-4 bottom-2 left-1/2 transform -translate-x-1/2">
