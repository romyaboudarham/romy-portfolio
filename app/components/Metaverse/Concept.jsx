    ...
    return (
        <section>
          ...
          <div>
            ...
            People study neighborhood health and that information isn't always readily accesible.Bring those findings to the user to mobilize, quesiton, get involved. 
            I decided to use the metaverse as an educational tool to get users more engaged in their community. transporting them to different neighborhoods
            and being able to wlak around and interact with the history and people of 
            </p>
...
/*
  The metaverse is employed as an immersive educational tool to help users understand the modern day realities of historically redlined neighborhoods in Oakland’s Alameda county. 
  The experience begins by asking the user to enter their race and income. Based on extensive research, the user is spawned within a realistic, immersive 3D world streamed by the Cesium plugin for Unreal. 
