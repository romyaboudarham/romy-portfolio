...
export default function Navbar({ textColor = 'text-black' }) {
  ...
  return (
    <>
      ...
      {!isAtTop && (
        <nav className="fixed bottom-4 md:top-2 md:left-4 right-4 z-[60]">
          {/* Floating Button */}
          <button 
  ...
  md:left-0 md:top-12 md:bottom-auto md:items-start md:text-left md:w-max bottom-12 flex flex-col items-end text-right min-w-max px-4">
