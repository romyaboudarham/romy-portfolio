  ...
  return (
    <div className="bg-[rgb(249,249,249)] text-black font-sans">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <div className="mt-6 space-y-2 lg:text-lg text-gray-800">
              <p><strong className="text-black opacity-90">Tools:</strong> Gemini AI, Python, Raspberry Pi, Physical Computing</p>
            </div>
          </div>
      ...
      <section className="mx-3 my-6 lg:my-10 lg:mx-[170px]">
          <h2 className="mb-7 lg:mb-14 text-3xl lg:text-4xl font-semibold text-center opacity-90">Implementation</h2>
          <Implementation />
      </section>
