...
export default function GriefsShadow() {
  ...
  return (
    <div className="bg-[#f9f9f9] text-black font-sans">
      ...
      {/* Project Overview */}
      <section className="mx-3 my-6 lg:my-8 md:mx-[170px] lg:mx-[230px]">
      ...
      {/* Dividing Line */}
      <div className="my-6 md:mx-[170px] lg:mx-[230px]">
      ...
      <section className="mx-3 my-6 lg:my-10 md:mx-[170px] lg:mx-[230px]">
          <h2 className="mb-7 lg:mb-14 text-3xl lg:text-4xl font-semibold text-center opacity-90">Conceptualization</h2>
          <Concept />
      </section>

      {/* Dividing Line */}
      <div className="my-6 mx-3 md:mx-[170px] lg:mx-[230px]">
        <div className="border-t-2 border-gray-300"></div> {/* The dividing line */}
      </div>
      ...
      {/* Final Experience */}
      <section className="mx-3 my-6 md:mx-[170px] lg:mx-[230px]">
